...
while True:
    ...
    # plot_landmark(mp_face_mesh.FACEMESH_RIGHT_EYEBROW)
    # plot_landmark(image, mp_face_mesh.FACEMESH_RIGHT_EYEBROW)
    plot_landmark(image, mp_face_mesh.FACEMESH_LEFT_EYEBROW)
